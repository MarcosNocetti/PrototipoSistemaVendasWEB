...
$redirect = 'http://localhost/Prototipomais/pages/login/fb.login.php';
...
if(! isset($accessToken)){
    ...
    $file = 'C:/wamp64/www/Prototipomais/assets/imgs/user_pics/user_avatar/'.md5($user['id']).'.jpg';     //Mudar a URL quando for hospedado!
